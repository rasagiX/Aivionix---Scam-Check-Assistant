    ...
    <div className="min-h-screen bg-gradient-to-r from-slate-950 via-indigo-950 to-black text-white flex items-center justify-center">
      <div className="max-w-md backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl shadow-2xl p-10 w-full mx-4">
        ...
        <form className="space-y-4">
          <input type="text" placeholder="Full Name" className="w-full p-3 rounded-lg bg-white/10 border border-white/20 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500" />
        ...
        <p className="text-center mt-6 text-gray-400">
          Already have account? <a href="/login" className="text-purple-400 hover:underline">Log in</a>
        </p>
